...
In MySQL
Based on http://hgdownload.soe.ucsc.edu/goldenPath/hgFixed/database/gtexInfo.*
Based on http://hgdownload.soe.ucsc.edu/goldenPath/hgFixed/database/gtexTissue.*
20191121 downloads
```shell
use hgFixed;
